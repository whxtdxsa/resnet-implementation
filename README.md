...
![Archtectures of models](assets/Screenshot_20250511_194133_Samsung_Notes.jpg)
...
![Loss graphs generated by mini_resnet models. In the plot, thin line is train loss and bold line is test loss. The mini_resnet_v4(red) shows the lowest loss. ](assets/comparison_loss.png)
...
![Test loss per hyperparameters.](assets/hyper_loss.png)
...
![Loss graph per hyperparameters which are top 8 of entire combination.  The bs32_ep15_lr_0.03 is the fastest one that converges to 0.1 loss.](assets/hyper_loss_subset.png)
...
![Accuracy graph of MiniResNet_v4. bs32_ep15_lr0.03. The model achieved 0.97 score.](assets/acc.png)
