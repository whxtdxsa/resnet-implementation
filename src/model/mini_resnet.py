...
class MiniResNet6(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=7, stride=1, padding=3)
        self.bn1 = nn.BatchNorm2d(8)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1) # 14

        self.layer1 = self._build_layer(8, 16)
...
class MiniResNet(nn.Module): #best1
    def __init__(self):
        super().__init__()
